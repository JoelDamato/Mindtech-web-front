    ...
    <>
      ...
      <div className='flex flex-col w-full min-h-[100vh] bg-white '>
        <div className='border border-black min-h-[70vh] w-full flex flex-col'>
          ...
          <div className='w-[100%] h-[70vh] border border-black sm:min-h-[90vh] flex flex-col items-center justify-around'>
            ...
            {statics === 1 && <div className='w-[100%] h-[50vh] sm:h-[50vh] md:h-[90vh] lg:w-[80%] lg:h-[70vh] flex flex-col items-center justify-around'>
              ...
              <div className="w-[90%] h-full border border-black bg-[#0000000e]  shadow-md  shadow-[#000000a8] rounded-[15px] flex justify-center items-center">
                <LineChart />
              </div>
            </div>}
            ...
            <div className='mt-4 mb-4 w-[90%] h-[5vh] flex items-center justify-evenly sm:w-[70%]  md:w-[50%]'>
              <div onClick={handleBars} className='flex justify-center items-center w-[15vw] h-[5vh] bg-[#000000ce] rounded-[15px] cursor-pointer shadow-md shadow-[#000000a6] hover:scale-[.9]'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18L9 11.25l4.306 4.307a11.95 11.95 0 015.814-5.519l2.74-1.22m0 0l-5.94-2.28m5.94 2.28l-2.28 5.941" />
                </svg>

              </div>
              <div onClick={handleLine} className='flex justify-center items-center w-[15vw] h-[5vh] bg-[#000000ce] rounded-[15px] cursor-pointer shadow-md shadow-[#000000a6] hover:scale-[.9]'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
Category 
Quantity */
//           {<input placeholder='Insert new brand' className='h-[5vh] w-[95%] bg-[#d6d6d6] rounded-[5px] placeholder:pl-2' type="text" name="" id="" onChange={(e) => setBrand(e.target.value)} />}
