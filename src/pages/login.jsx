...
<div className='bg-[#D9D9D9] h-[full] sm:h-[95%] w-full rounded-tl-[60px] sm:w-[95%] sm:rounded-[50px] flex mob:flex-col mob:items-center '>
    ...
    <div className='sm:flex sm:flex-col mob:w-[100%] sm:w-[50%] sm:items-center'>
      ...
      <form className='flex flex-col w-[100%] items-center gap-5 sm:mt-[6%]' > 
      ...
      <input className='bg-black rounded-[20px] w-[80%] sm:h-[8vh] sm:w-[55%] h-[10vh] tracking-[8px] text-[3vh]' type="submit" value="SIGN UP" />
      </form>
...
<div className='sm:flex sm:flex-col mob:w-[100%] sm:w-[50%] sm:items-center'>
      <h1 className='flex w-[100%]   justify-center text-black text-[3vh] sm:text-[5vh] tracking-[12px] py-8'>REGISTER</h1>
      ...
      <button className='bg-white rounded-[20px] w-[80%] sm:h-[8vh] sm:w-[55%] h-[10vh] tracking-[3px] text-black text-[2vh] font-bold flex items-center pl-5 gap-5 sm:mt-[4vh]'> <img src="https://rotulosmatesanz.com/wp-content/uploads/2017/09/2000px-Google_G_Logo.svg_.png" className='w-[35px] h-[35px] sm:mr-5 ' alt="" /> SIGN IN WITH GOOGLE</button>
